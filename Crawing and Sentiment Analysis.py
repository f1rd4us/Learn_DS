...
#function for crawling data from twitter
    ...
    def crawling(self, angka):
        consumer_key = 'NkEnaPrZ3cVnxLVYx4VA6cVvT'
        consumer_secret = 'b3UPwJsE5jJ8eY6ScxQwbqhKlKeuRyThWk4LQ3amHoFmYeU2MC'
        access_token = '1316221654616293378-2OK8EvHIU3CtLpNIESMaW02HrWgojo'
        access_token_secret = 'm2Ixl5Z0iWOR92uCeeofgX67FWa2ceodeQeZtUKPv7z4B'
